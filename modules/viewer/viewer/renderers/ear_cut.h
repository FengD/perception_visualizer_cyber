...
template <>
struct nth<0, Eigen::Vector2f> {
  inline static float get(const Eigen::Vector2f& v) { return v(0); };
};
template <>
struct nth<1, Eigen::Vector2f> {
  inline static float get(const Eigen::Vector2f& v) { return v(1); };
};
template <>
struct nth<0, Eigen::VectorXf> {
  inline static float get(const Eigen::VectorXf& v) { return v(0); };
};
template <>
struct nth<1, Eigen::VectorXf> {
  inline static float get(const Eigen::VectorXf& v) { return v(1); };
};
